...
Usage:
    poetry run python scripts/ingest_one.py                 # sc:mn1/sujato
...
from config.settings import DatabaseSettings  # noqa: E402
...
def main(argv: list[str]) -> None:
    ...
    orchestrator = IngestionOrchestrator(
        vector_store_config=VectorStoreConfig(collection_name=_COLLECTION, db_url=neon_url)
    )

    print(f"Ingesting {source!r} into collection {_COLLECTION!r} ...")
